...
P0 is the first automated embodied consumer that composes direct Matter editing, actor support and provider lifecycle through the real LAB. It is **integrated consumer evidence, not playability/product evidence**: human interaction quality, selection UX, feel and perceived latency remain Owner-test questions.
...
- P0 automated composition is green in a translation+yaw scope,
- P0 also exposed arbitrary pitch/roll support as a real unresolved actor-semantic frontier.

The next highest-information evidence should come from direct Owner use of the P0 LAB. That result should decide whether representation latency, actor semantics, lifecycle continuity, interaction UX or another pressure deserves the next campaign.